package com.lengyue.databinding_base.network.Interceptor;
...
public class OfflineCacheInterceptor implements Interceptor {
    ...
    private OfflineCacheInterceptor(Context context) {
        this.context = context;
    }

    public static OfflineCacheInterceptor getInstance(Context context) {
        if (offlineCacheInterceptor == null) {
            synchronized (OfflineCacheInterceptor.class) {
                if (offlineCacheInterceptor == null) {
                    offlineCacheInterceptor = new OfflineCacheInterceptor(context);
                }
            }
        }
